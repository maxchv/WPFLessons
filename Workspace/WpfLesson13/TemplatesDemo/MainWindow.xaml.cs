...
namespace TemplatesDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void MakeVisualTree(DependencyObject elem,
                                     TreeViewItem parentNode = null)
        {
            // текущий узел визуального дерева
            TreeViewItem currentNode = new TreeViewItem();
            currentNode.Header = elem.GetType().Name;
            currentNode.IsExpanded = true;

            if (parentNode == null) // только для Window
            {
                tv.Items.Add(currentNode);
            }
            else
            {
            ...
            {
                MakeVisualTree(VisualTreeHelper.GetChild(elem, i), currentNode);
            }
